...
function ww_custom_footer() {
	...
	'.$footernav.'
	<p>©'.date('Y').' Material Acquisition Services&reg; and it\'s logo are registered trademarks and may not be used without express written consent.</p><p><a href="http://waimanwong.com">Web Design by Wai Man Wong</a></p><p><a id="scroll-top-btn" title="Go to top"><i class="fa fa-arrow-circle-up"></i></a></p>
	</div>
	</div>';
}
